...
<!-- <div class="card shadow mb-4"> -->
    <div class="card-header py-3">
        <h2 class="m-0 font-weight-bold text-primary">
          ...
          <font color="#999">แก้ไขการรับสมัคร</font></h2>
    </div>
    <div class="card-body">
...
<div class="row">
  <div class="col-md-12">
    <form method="post" action="">
         @csrf
         <h4><i class="fa fa-edit"></i> แก้ไขข้อมูลการรับสมัคร</h4>
         <div class="form-row">
         ...
         <div class="form-row">
          ...
          <div class="form-group col-md-3">
            <label >ชื่อรอบ </label>
            <input type="text" class="form-control" value="{{$data->name_round}}" name="name_round" autocomplete="no" placeholder="ชื่อรอบ">
          </div>
          <div class="form-group col-md-2">
            <label >เวลาเปิดรับสมัคร</label>
            <input id="dateOpen" name="openDate" value="{{ $data->openDate }}" class="form-control mb-2"/>
          </div>

          <div class="form-group col-md-2">
            <label >เวลาปิดรับสมัคร</label>
            <input id="dateClose" data-date-format="dd-mm-yyyy" type="text"  value="{{ $data->closeDate }}"class="form-control" name="closeDate" autocomplete="off">
          </div>

           <div class="form-group col-md-2">
            <label>จำนวนการรับสมัคร</label>
            <input type="number" class="form-control" value="{{$data->amount}}" required name="amount" autocomplete="off">
          </div>
