...
<!-- <div class="card shadow mb-4"> -->
    <div class="card-header py-3">
        <h2 class="m-0 font-weight-bold text-primary">ประกาศผลการสอบคัดเลือก</h2>
    </div>
    <div class="card-body">
    ...
    <div class="table-responsive">
      <table id="dataTable1" class="table table-hover table-bordered table-striped" width="2350px">
        <thead>
          <tr>
            <th colspan="5"><center>ข้อมูล</center></th>
          ...
          <tr>
            ...
            <td align="center">ผ่านการคัดเลือก</td>
            <!-- <td>ที่</td> -->
        ...
        <tbody>
          ...
          @foreach($applyData as $app)
            ...
            <!-- <td>{{$i++}}</td> -->
            <td><a href="/@if(Auth::user()->type == 2){{'dept'}}@else{{'admin'}}@endif/app/{{$app->aid}}">{{$app->firstname." ".$app->lastname}}</a></td>
            <td>{{$app->telephone}}</td>
            <td>{{$app->edu_type}}</td>
