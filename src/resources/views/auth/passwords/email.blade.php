              ...
              <div class="row">
                ...
                <div style="padding-top: 0px; padding-bottom: 50px;">
                    ...
                    <!-- <img src="/images/KMUTT.png" width="150"> -->
                      ...
                      <h1 class="h4 text-gray-900 mb-2">Request to reset password</h1>
                    </div>
                                    <div class="card-body">
                    @if (session('status'))
                        <div class="alert alert-success" role="alert" style="line-height: 1.5rem;"><center>
                            {{ session('status') }}<br>
                            กรุณาตรวจสอบอีเมลของคุณ ระบบได้ส่งลิงก์สำหรับตั้งค่ารหัสผ่านใหม่ให้แล้ว
                        </center>
                        </div>
                    @endif

                    <form method="POST" onsubmit="wait()" action="/password/email">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input autofocus id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button id="submit" type="submit" class="btn btn-primary" style="background-color: #F37733; color: #fff; border-color: #f37733;">
